...
if (empty($category)) {
    ...
    echo "<script>document.location='offsupps_add.php'</script>";
    exit();
}

//INSERT DATA INTO THE TABLE
$inSQL = "INSERT INTO offsupps(PROD_NAME, QUANT_RECEIVE, QUANT_USED, CATEGORY, RECEIVER, DATE_RECEIVE)
VALUES(:prod_name, :quant_receive, :quant_used, :category, :receiver, :date_receive)";
...
if ($stmt->execute()) {
    ...
    echo "<script>document.location='offsupps_view.php'</script>";
} else {
