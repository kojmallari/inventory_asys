...
$inSQL = "INSERT INTO printersupps(PROD_NAME, PROD_CODE, QUANT_STOCK, QUANT_USED, CATEGORY, RECEIVER, DATE_RECEIVE)
VALUES(:prod_name, :prod_code, :quant_stock, :quant_used, :category, :receiver, :date_receive)";
...
if ($stmt->execute()) {
    ...
    echo "<script>document.location='printersupps_view.php'</script>";
} else {
