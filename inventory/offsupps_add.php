        ...
        <div class="flex flex-col items-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form method="POST" action="offsupps_add_back.php">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div class="w-full">
                                <label for="quant_receive" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quantity (Received)</label>
                                <input type="number" name="quant_receive" id="quant_receive" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter number of received supplies" required="">
                            </div>
                            <div class="w-full">
                                <label for="quant_used" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Quantity (In Use)</label>
                                <input type="number" name="quant_used" id="quant_used" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter number of supplies in use" required="">
                            </div>
                            <div>
