...
<head>
    ...
    <title>ITSS Inventory System | Home</title>
...
<body>
        ...
        <div id="carousel-container" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="uploads/haubg.jpg" class="d-block w-100" alt="carousel-item1">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="uploads/haubg2.jpg" class="d-block w-100" alt="carousel-item2">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="uploads/haubg4.jpg" class="d-block w-100" alt="carousel-item3">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
            </div>
    ...
    <footer class="bg-body-tertiary text-center text-lg-start">
        <hr class="my-3">
        <div class="text-center align-items-center p-3 pt-4 pb-4" style="background-color: white;">
            © 2024 Copyright. <a class="text-body" href="https://www.hau.edu.ph/">All rights reserved to Holy Angel University.</a>
        </div>
    </footer>
</body>
</html>